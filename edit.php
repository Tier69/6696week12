...
<form action="edit_1.php" method="POST">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
        <input type="text" name="first_name" class="form-control" maxlength="10" Value=<?php echo$row['first_name']; ?> required>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
        <input type="text" name="last_name" class="form-control" maxlength="10" Value=<?php echo$row['last_name']; ?> required>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <select name="department" class="form-select" aria-label="Default select example">
               <option >กรุณาระบุแผนกนะจ๊ะ</option>
               ...
               <option value="ฝ่ายไอที"<?php if ($row['']=='ฝ่ายไอที'){ echo "selected";} ?>>ฝ่ายไอที</option>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <select name="gender" class="form-select" aria-label="Default select example">
               <option >กรุณาระบุเพศนะจ๊ะ</option>
               <option value="ฝ่ายบุคคล"<?php if ($row['gender']=='ชาย'){ echo "selected";} ?>>ชาย</option>
               <option value="หญิง"<?php if ($row['gender']=='หญิง'){ echo "selected";} ?>>หญิง</option>
               <option value="อื่นๆ"<?php if ($row['gender']=='LGBTQ+'){ echo "selected";} ?>>LGBTQ+</option>
</select>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
        <input type="text" name="age" class="form-control" maxlength="10" Value=<?php echo$row['age']; ?> required>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
        <input type="text" name="salary" class="form-control" maxlength="10" Value=<?php echo$row['salary']; ?> required>
        </div>
    </div>
